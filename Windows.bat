...
goto UACPrompt
:UACPrompt
if exist "C:\Program Files (x86)\gsudo\Current\gsudo.exe" sudo "%~s0"
if exist "C:\Program Files\gsudo\Current\gsudo.exe" sudo "%~s0"
...
-EncodedCommand
') do set PythonURL=%%i
