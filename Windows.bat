...
if "%errorlevel%"=="0" (
		Powershell -command "irm https://raw.githubusercontent.com/Neo1102/Twitch-Channel-Points-Miner-Auto-Deploy/main/winget_optimize.ps1|iex"
...
Powershell -command "irm https://raw.githubusercontent.com/Neo1102/Twitch-Channel-Points-Miner-Auto-Deploy/main/wt_modify.ps1|iex"
